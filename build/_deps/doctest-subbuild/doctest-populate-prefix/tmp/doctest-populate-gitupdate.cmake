...
execute_process(
  COMMAND "C:/Program Files/Git/bin/git.exe" --git-dir=.git show-ref "ae7a13539fb71f270b87eb2e874fbac80bc8dda2"
  WORKING_DIRECTORY "C:/Users/User/Desktop/AfterSchool/Repo1/Defender-Arcade-Game/build/_deps/doctest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/User/Desktop/AfterSchool/Repo1/Defender-Arcade-Game/build/_deps/doctest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/User/Desktop/AfterSchool/Repo1/Defender-Arcade-Game/build/_deps/doctest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()

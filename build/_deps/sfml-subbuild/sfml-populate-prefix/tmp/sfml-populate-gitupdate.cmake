...
execute_process(
  COMMAND "C:/Program Files/Git/bin/git.exe" --git-dir=.git show-ref "11b73743c42cf7ecd7c596ba83fdbf1150ffa96c"
  WORKING_DIRECTORY "C:/Users/User/Desktop/AfterSchool/Repo1/Defender-Arcade-Game/build/_deps/sfml-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 11b73743c42cf7ecd7c596ba83fdbf1150ffa96c")
    return()
  endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/User/Desktop/AfterSchool/Repo1/Defender-Arcade-Game/build/_deps/sfml-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/User/Desktop/AfterSchool/Repo1/Defender-Arcade-Game/build/_deps/sfml-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
